...
public class Main {
    public static void main(String[] args){
        ...
        System.out.println("give me your name or suffer");

        System.out.println("First name :");
        String first = keystrokes.nextLine().trim();

        System.out.println("middle initial (press Enter to skip)? :");
        String middle = keystrokes.nextLine().trim();

        System.out.println("last name? :");
        String last = keystrokes.nextLine().trim();
